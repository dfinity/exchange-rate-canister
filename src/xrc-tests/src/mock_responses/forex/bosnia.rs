        ...
        "CurrencyExchangeItems": [
            {
                ...
                "Units": "1",
                "Buy": "1,955830",
                "Middle": rates.get("EUR").cloned().unwrap_or("1,955830"),
                "Sell": "1,955830",
                "Star": null
            },
            {
                ...
                "Units": "100",
                "Buy": "1,361913",
                "Middle": rates.get("JPY").cloned().unwrap_or("1,365326"),
                "Sell": "1,368739",
                "Star": null
            },
            {
                ...
                "Units": "1",
                "Buy": "2,263272",
                "Middle": rates.get("GBP").cloned().unwrap_or("2,268944"),
                "Sell": "2,274616",
                "Star": null
            },
            {
                ...
                "Units": "1",
                "Buy": "1,845384",
                "Middle": rates.get("USD").cloned().unwrap_or("1,850009"),
                "Sell": "1,854634",
                "Star": null
            },
            {
                ...
                "Units": "1",
                "Buy": "0,275802",
                "Middle": rates.get("CNY").cloned().unwrap_or("0,276493"),
                "Sell": "0,277184",
                "Star": null
            }
        ],
